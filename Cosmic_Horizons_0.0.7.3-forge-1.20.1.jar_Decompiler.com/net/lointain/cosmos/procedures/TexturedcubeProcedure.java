...
public class TexturedcubeProcedure {
   ...
   private static boolean begin(VertexFormat.Mode mode, boolean texture, boolean update) {
      if (bufferBuilder == null || !bufferBuilder.m_85732_()) {
         ...
         if (vertexBuffer == null) {
            TexturedcubeProcedure.texture = texture;
   ...
   private static VertexBuffer execute(@Nullable Event event) {
      ...
      if (begin(Mode.QUADS, true, true)) {
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.375F, 0.0F, -6250336);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 0.375F, 0.25F, -6250336);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.25F, 0.25F, -6250336);
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.25F, 0.0F, -6250336);
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.125F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.125F, 0.25F, -1);
         add((double)0.5F, (double)0.5F, (double)0.5F, 0.25F, 0.25F, -1);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.25F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.125F, 0.25F, -2039584);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.125F, 0.5F, -2039584);
         ...
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.375F, 0.5F, -4144960);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.375F, 0.25F, -4144960);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.375F, 0.25F, -2039584);
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.375F, 0.5F, -2039584);
         ...
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.125F, 0.5F, -4144960);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.125F, 0.25F, -4144960);
         end();
      }
