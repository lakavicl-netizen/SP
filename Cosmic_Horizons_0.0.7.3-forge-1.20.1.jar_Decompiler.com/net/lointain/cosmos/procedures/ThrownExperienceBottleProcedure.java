...
@EventBusSubscriber
public class ThrownExperienceBottleProcedure {
   @SubscribeEvent
   public static void onEventTriggered(ThrownExperienceBottleTickEvent event) {
      ...
      if (entity != null) {
         ...
         if (ApplyGravityLogicProcedure.execute(world, dim)) {
            ...
            if (gravity == (double)0.0F) {
               ...
               entity.m_20256_(new Vec3(entity.m_20184_().m_7096_(), (entity.m_20184_().m_7098_() / 0.98 + 0.07 - gravity * 0.07) * FrictionDataProviderProcedure.execute(world, dim), entity.m_20184_().m_7094_()));
            }
         }
