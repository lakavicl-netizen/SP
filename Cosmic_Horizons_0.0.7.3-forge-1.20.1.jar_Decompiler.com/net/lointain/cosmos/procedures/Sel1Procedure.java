...
public class Sel1Procedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         ...
         if (t_size > (double)0.0F) {
            Tag var16 = final_list.get((int)((double)0.0F + ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter));
            CompoundTag var21;
