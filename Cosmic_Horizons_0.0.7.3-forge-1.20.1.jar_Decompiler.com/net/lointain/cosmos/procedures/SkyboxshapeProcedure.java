...
public class SkyboxshapeProcedure {
   ...
   private static boolean begin(VertexFormat.Mode mode, boolean texture, boolean update) {
      if (bufferBuilder == null || !bufferBuilder.m_85732_()) {
         ...
         if (vertexBuffer == null) {
            SkyboxshapeProcedure.texture = texture;
   ...
   private static VertexBuffer execute(@Nullable Event event) {
      if (begin(Mode.QUADS, true, true)) {
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.0F, 0.0F, -1);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.5F, -1);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 0.33333334F, 0.5F, -1);
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.33333334F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.33333334F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.33333334F, 0.5F, -1);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.6666667F, 0.5F, -1);
         add((double)0.5F, (double)0.5F, (double)0.5F, 0.6666667F, 0.0F, -1);
         add((double)0.5F, (double)0.5F, (double)0.5F, 0.6666667F, 0.0F, -1);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 0.6666667F, 0.5F, -1);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 1.0F, 0.5F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 1.0F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.5F, -1);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.0F, 1.0F, -1);
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.33333334F, 1.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.33333334F, 0.5F, -1);
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.33333334F, 0.5F, -1);
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.33333334F, 1.0F, -1);
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.6666667F, 1.0F, -1);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.6666667F, 0.5F, -1);
         add((double)0.5F, (double)0.5F, (double)-0.5F, 0.6666667F, 0.5F, -1);
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.6666667F, 1.0F, -1);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 1.0F, 1.0F, -1);
         add((double)0.5F, (double)0.5F, (double)0.5F, 1.0F, 0.5F, -1);
         end();
      }
