...
@OnlyIn(Dist.CLIENT)
public class AerialLightRenderer {
   ...
   public static void onRegisterShader(RegisterShadersEvent event) {
      try {
         ...
         flashLightPass = new PostChain(Minecraft.m_91087_().m_91097_(), Minecraft.m_91087_().m_91098_(), Minecraft.m_91087_().m_91385_(), new ResourceLocation("cosmos", "shaders/post/aerial_light.json"));
   ...
   public static void renderLight(Vec3 position, Vec3 direction, float brightness, float range, float radius, float outerRadius, Vec3 color, PoseStack poseStack) {
      ...
      Uniform rangeUniform = effect.m_108952_("Range");
      Uniform radiusUniform = effect.m_108952_("Radius");
      Uniform radiusOutterUniform = effect.m_108952_("RadiusOuter");
      Uniform directionUniform = effect.m_108952_("Direction");
      ...
      if (directionUniform != null) {
         directionUniform.m_142276_(direction.m_252839_());
         directionUniform.m_85633_();
      }

      if (radiusUniform != null) {
         radiusUniform.m_5985_((float)Math.cos(Math.toRadians((double)radius)));
         radiusUniform.m_85633_();
      }

      if (radiusOutterUniform != null) {
         radiusOutterUniform.m_5985_((float)Math.cos(Math.toRadians((double)outerRadius)));
         radiusOutterUniform.m_85633_();
      }

      if (rangeUniform != null) {
         rangeUniform.m_5985_(range);
         rangeUniform.m_85633_();
      }
