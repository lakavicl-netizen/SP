...
public class CosmeticRendererProcedure {
   ...
   private static boolean begin(VertexFormat.Mode mode, boolean texture, boolean update) {
      if (bufferBuilder == null || !bufferBuilder.m_85732_()) {
         ...
         if (vertexBuffer == null) {
            CosmeticRendererProcedure.texture = texture;
   ...
   private static void scale(float scale) {
      CosmeticRendererProcedure.scale = scale;
   }
   ...
   private static void system(boolean worldCoordinate) {
      CosmeticRendererProcedure.worldCoordinate = worldCoordinate;
   }

   private static boolean target(int targetStage) {
      if (targetStage == currentStage) {
         CosmeticRendererProcedure.targetStage = targetStage;
         return true;
      } else {
         return false;
      }
   ...
   private static void execute(@Nullable Event event) {
      ...
      VertexBuffer planets = null;
      double tick = (double)0.0F;
      double Xpos = (double)0.0F;
      double Ypos = (double)0.0F;
      double Zpos = (double)0.0F;
   }
