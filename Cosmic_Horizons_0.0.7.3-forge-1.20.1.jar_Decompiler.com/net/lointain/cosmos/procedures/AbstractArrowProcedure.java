...
@EventBusSubscriber
public class AbstractArrowProcedure {
   @SubscribeEvent
   public static void onEventTriggered(ArrowTickEvent event) {
      ...
      if (entity != null) {
         ...
         if (!((<undefinedtype>)(new Object() {
            public boolean getValue() {
               ...
               return dataIndex.m_128471_("inGround");
            }
         })).getValue()) {
            ...
            if (ApplyGravityLogicProcedure.execute(world, dim)) {
               ...
               if (gravity == (double)0.0F) {
                  ...
                  entity.m_20256_(new Vec3(entity.m_20184_().m_7096_(), (entity.m_20184_().m_7098_() / 0.98 + 0.05 - gravity * 0.05) * FrictionDataProviderProcedure.execute(world, dim), entity.m_20184_().m_7094_()));
               }
            }
         }
