...
public class UnderfrozenwaterProcedure {
   ...
   public static void renderFog(ViewportEvent.RenderFog event) {
      ...
      if (provider.getMode() == FogMode.FOG_TERRAIN) {
         ...
         if (level != null && entity != null) {
            ...
            execute(provider, entity, provider.getPartialTick());
         }
      }
   ...
   private static void execute(@Nullable Event event, Entity entity, double partialTick) {
      if (entity != null) {
         if (entity.m_9236_().m_46472_() == ResourceKey.m_135785_(Registries.f_256858_, new ResourceLocation("cosmos:europa_lands")) && entity.m_20318_((float)partialTick).m_7098_() < (double)38.0F) {
            setShape(FogShape.CYLINDER);
            setDistance(45.0F, 200.0F);
         }
