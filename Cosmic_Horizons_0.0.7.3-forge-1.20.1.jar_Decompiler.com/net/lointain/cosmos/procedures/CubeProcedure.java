...
public class CubeProcedure {
   ...
   private static VertexBuffer execute(@Nullable Event event) {
      ...
      if (begin(Mode.QUADS, false, true)) {
         add((double)0.5F, (double)-0.5F, (double)-0.5F, 0.0F, 0.0F, -6250336);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.0F, -6250336);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.0F, -6250336);
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.0F, 0.0F, -6250336);
         ...
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.0F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.0F, -1);
         add((double)-0.5F, (double)0.5F, (double)-0.5F, 0.0F, 0.0F, -4144960);
         add((double)-0.5F, (double)-0.5F, (double)-0.5F, 0.0F, 0.0F, -4144960);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.0F, -4144960);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.0F, -4144960);
         add((double)-0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.0F, -2039584);
         add((double)-0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.0F, -2039584);
         add((double)0.5F, (double)-0.5F, (double)0.5F, 0.0F, 0.0F, -2039584);
         add((double)0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.0F, -2039584);
         add((double)0.5F, (double)0.5F, (double)0.5F, 0.0F, 0.0F, -4144960);
