...
public class CorrodedSulpherTNTOnBlockRightClickedProcedure {
         ...
         if (entity.m_9236_().m_46472_() == Level.f_46428_ && entity.m_9236_().m_46472_() == Level.f_46430_ && entity.m_9236_().m_46472_() == Level.f_46429_) {
            if (entity.m_9236_().m_46472_() == Level.f_46428_ || entity.m_9236_().m_46472_() == Level.f_46430_ || entity.m_9236_().m_46472_() == Level.f_46429_) {
               ...
               if (world instanceof ServerLevel) {
                  ...
                  Entity entityToSpawn = ((EntityType)CosmosModEntities.ENTITYCORRODEDSULPHERTNT.get()).m_262496_(_level, BlockPos.m_274561_(x, y, z), MobSpawnType.MOB_SUMMONED);
