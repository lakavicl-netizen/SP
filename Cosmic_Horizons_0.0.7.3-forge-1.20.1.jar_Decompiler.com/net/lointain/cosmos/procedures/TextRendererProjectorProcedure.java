...
public class TextRendererProjectorProcedure {
   ...
   private static boolean target(int targetStage) {
      if (targetStage == currentStage) {
         TextRendererProjectorProcedure.targetStage = targetStage;
         return true;
      } else if (targetStage == 1 && currentStage != 0) {
         TextRendererProjectorProcedure.targetStage = currentStage;
         return true;
      } else {
         return false;
      }
   ...
   private static void execute(@Nullable Event event) {
      double centre_X = (double)0.0F;
      double centre_Y = (double)0.0F;
      String texts = "";
      ...
      new JsonObject();
      new JsonObject();
      centre_X = (double)(Minecraft.m_91087_().m_91268_().m_85445_() / 2);
      centre_Y = (double)(Minecraft.m_91087_().m_91268_().m_85446_() / 2);
         ...
         if (target(3)) {
            if (entity instanceof Player) {
               ...
               if (_plr2.f_36096_ instanceof ProjectionSelectorMenu) {
                  for(int m = (int)((double)0.0F + ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter); m < (int)((double)(CosmosModVariables.WorldVariables.get(world).projection_list.size() < 2 ? CosmosModVariables.WorldVariables.get(world).projection_list.size() : 2) + ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter); ++m) {
                     Tag var24 = CosmosModVariables.WorldVariables.get(world).projection_list.get(m);
                     JsonObject var10000;
                     if (var24 instanceof StringTag) {
                        StringTag _stringTag = (StringTag)var24;
                     ...
                     for(Tag dataelementiterator : ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).traveled_dimentions) {
                        String var36 = data.get("attached_dimention_id").getAsString();
                        String var10001;
                     ...
                     if (travel_logic) {
                        renderTexts(data.get("local_id").getAsString(), (float)(centre_X + (double)-71.0F + (double)74.0F * ((double)m - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter) + (double)35.5F + (double)1.0F), (float)(centre_Y + (double)-80.0F + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -6750208, 4);
                        renderTexts(data.get("local_id").getAsString(), (float)(centre_X + (double)-71.0F + (double)74.0F * ((double)m - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter) + (double)35.5F), (float)(centre_Y + (double)-80.0F + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -39322, 4);
                     } else {
                        renderTexts("? ? ?", (float)(centre_X + (double)-71.0F + (double)74.0F * ((double)m - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter) + (double)35.5F + (double)1.0F), (float)(centre_Y + (double)-80.0F + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -6750208, 4);
                        renderTexts("? ? ?", (float)(centre_X + (double)-71.0F + (double)74.0F * ((double)m - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_iter) + (double)35.5F), (float)(centre_Y + (double)-80.0F + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -39322, 4);
                     }
                  }

                  Tag var31 = CosmosModVariables.WorldVariables.get(world).projection_list.get((int)((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).page_sel_index);
                  JsonObject var37;
                  if (var31 instanceof StringTag) {
                     StringTag _stringTag = (StringTag)var31;
                     var37 = (JsonObject)(new Gson()).fromJson(_stringTag.m_7916_(), JsonObject.class);
                  } else {
                     var37 = new JsonObject();
                  }

                  JsonObject render_planet_data = var37;
                  JsonObject planet_data = render_planet_data.get("planet_data").getAsJsonObject();

                  for(int h = (int)((double)0.0F + ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter); h < (int)((double)(planet_data.size() < 4 ? planet_data.size() : 4) + ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter); ++h) {
                     JsonObject mint_data = planet_data.get((String)planet_data.keySet().stream().toList().get(h)).getAsJsonObject();
                     if (mint_data.has("travel_to")) {
                        if (!mint_data.get("travel_to").getAsString().equals("none")) {
                           for(Tag dataelementiterator : ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).traveled_dimentions) {
                              String var38 = mint_data.get("travel_to").getAsString();
                              String var39;
                              if (dataelementiterator instanceof StringTag) {
                                 StringTag _stringTag = (StringTag)dataelementiterator;
                     ...
                     if (travel_logic) {
                        renderTexts(mint_data.get("object_name").getAsString(), (float)(centre_X + (double)-34.0F + (double)35.5F + (double)1.0F), (float)(centre_Y + (double)-41.0F - (double)-27.0F * ((double)h - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter) + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -6750208, 4);
                        renderTexts(mint_data.get("object_name").getAsString(), (float)(centre_X + (double)-34.0F + (double)35.5F), (float)(centre_Y + (double)-41.0F - (double)-27.0F * ((double)h - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter) + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -39322, 4);
                     } else {
                        renderTexts("???", (float)(centre_X + (double)-34.0F + (double)35.5F + (double)1.0F), (float)(centre_Y + (double)-41.0F - (double)-27.0F * ((double)h - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter) + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -6750208, 4);
                        renderTexts("???", (float)(centre_X + (double)-34.0F + (double)35.5F), (float)(centre_Y + (double)-41.0F - (double)-27.0F * ((double)h - ((CosmosModVariables.PlayerVariables)entity.getCapability(CosmosModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CosmosModVariables.PlayerVariables())).planet_page_iter) + (double)10.0F + (double)1.0F), 0.0F, 0.0F, 1.0F, -39322, 4);
                     }
                  }
               }
            }
