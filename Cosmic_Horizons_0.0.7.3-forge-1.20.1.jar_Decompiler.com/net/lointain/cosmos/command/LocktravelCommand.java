...
import net.lointain.cosmos.procedures.TravellockProcedure;
...
@EventBusSubscriber
public class LocktravelCommand {
   @SubscribeEvent
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_("lock").requires((s) -> s.m_6761_(2))).executes((arguments) -> {
         ...
         TravellockProcedure.execute(entity);
         return 0;
      }));
   }
}
