...
public abstract class NickelSuitItem extends ArmorItem {
   public NickelSuitItem(ArmorItem.Type type, Item.Properties properties) {
      super(new ArmorMaterial() {
         public int m_266425_(ArmorItem.Type type) {
            return (new int[]{13, 15, 16, 11})[type.m_266308_().m_20749_()] * 17;
         }
         ...
         public Ingredient m_6230_() {
            return Ingredient.m_43927_(new ItemStack[]{new ItemStack((ItemLike)CosmosModItems.NICKLE_PLATE.get())});
         }
   ...
   public static class Helmet extends NickelSuitItem {
      public Helmet() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final NickelSuitItem.Helmet this$0;
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "cosmos:textures/entities/space_suit_nickel_vibrant.png";
      }
   }

   public static class Chestplate extends NickelSuitItem {
      public Chestplate() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final NickelSuitItem.Chestplate this$0;
   ...
   public static class Leggings extends NickelSuitItem {
      public Leggings() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final NickelSuitItem.Leggings this$0;
   ...
   public static class Boots extends NickelSuitItem {
      public Boots() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final NickelSuitItem.Boots this$0;
