...
public abstract class SteelSuitItem extends ArmorItem {
   public SteelSuitItem(ArmorItem.Type type, Item.Properties properties) {
      super(new ArmorMaterial() {
         ...
         public Ingredient m_6230_() {
            return Ingredient.m_43927_(new ItemStack[]{new ItemStack((ItemLike)CosmosModItems.STEEL_PLATE.get())});
         }
   ...
   public static class Helmet extends SteelSuitItem {
      public Helmet() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final SteelSuitItem.Helmet this$0;
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "cosmos:textures/entities/space_suit_steel_vibrant.png";
      }
   }

   public static class Chestplate extends SteelSuitItem {
      public Chestplate() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final SteelSuitItem.Chestplate this$0;
   ...
   public static class Leggings extends SteelSuitItem {
      public Leggings() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final SteelSuitItem.Leggings this$0;
   ...
   public static class Boots extends SteelSuitItem {
      public Boots() {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            // $FF: synthetic field
            final SteelSuitItem.Boots this$0;
