...
public class NickelRoverEntity extends PathfinderMob {
   public NickelRoverEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)CosmosModEntities.NICKEL_ROVER.get(), world);
   }

   public NickelRoverEntity(EntityType<NickelRoverEntity> type, Level world) {
      super(type, world);
      this.m_274367_(1.0F);
      this.f_21364_ = 0;
      this.m_21557_(false);
      ...
      this.f_21342_ = new MoveControl(this) {
         public void m_8126_() {
            if (NickelRoverEntity.this.m_20069_()) {
               NickelRoverEntity.this.m_20256_(NickelRoverEntity.this.m_20184_().m_82520_((double)0.0F, 0.005, (double)0.0F));
            }

            if (this.f_24981_ == Operation.MOVE_TO && !NickelRoverEntity.this.m_21573_().m_26571_()) {
               double dx = this.f_24975_ - NickelRoverEntity.this.m_20185_();
               double dy = this.f_24976_ - NickelRoverEntity.this.m_20186_();
               double dz = this.f_24977_ - NickelRoverEntity.this.m_20189_();
               float f = (float)(Mth.m_14136_(dz, dx) * (180D / Math.PI)) - 90.0F;
               float f1 = (float)(this.f_24978_ * NickelRoverEntity.this.m_21051_(Attributes.f_22279_).m_22135_());
               NickelRoverEntity.this.m_146922_(this.m_24991_(NickelRoverEntity.this.m_146908_(), f, 10.0F));
               NickelRoverEntity.this.f_20883_ = NickelRoverEntity.this.m_146908_();
               NickelRoverEntity.this.f_20885_ = NickelRoverEntity.this.m_146908_();
               if (NickelRoverEntity.this.m_20069_()) {
                  NickelRoverEntity.this.m_7910_((float)NickelRoverEntity.this.m_21051_(Attributes.f_22279_).m_22135_());
                  ...
                  NickelRoverEntity.this.m_146926_(this.m_24991_(NickelRoverEntity.this.m_146909_(), f2, 5.0F));
                  float f3 = Mth.m_14089_(NickelRoverEntity.this.m_146909_() * ((float)Math.PI / 180F));
                  NickelRoverEntity.this.m_21564_(f3 * f1);
                  NickelRoverEntity.this.m_21567_((float)((double)f1 * dy));
               } else {
                  NickelRoverEntity.this.m_7910_(f1 * 0.05F);
               }
            } else {
               NickelRoverEntity.this.m_7910_(0.0F);
               NickelRoverEntity.this.m_21567_(0.0F);
               NickelRoverEntity.this.m_21564_(0.0F);
            }
