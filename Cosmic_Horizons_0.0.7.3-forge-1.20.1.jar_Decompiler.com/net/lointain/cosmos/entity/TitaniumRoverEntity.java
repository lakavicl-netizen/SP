...
public class TitaniumRoverEntity extends PathfinderMob {
   public TitaniumRoverEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)CosmosModEntities.TITANIUM_ROVER.get(), world);
   }

   public TitaniumRoverEntity(EntityType<TitaniumRoverEntity> type, Level world) {
      super(type, world);
      this.m_274367_(1.0F);
      this.f_21364_ = 0;
      this.m_21557_(false);
      ...
      this.f_21342_ = new MoveControl(this) {
         public void m_8126_() {
            if (TitaniumRoverEntity.this.m_20069_()) {
               TitaniumRoverEntity.this.m_20256_(TitaniumRoverEntity.this.m_20184_().m_82520_((double)0.0F, 0.005, (double)0.0F));
            }

            if (this.f_24981_ == Operation.MOVE_TO && !TitaniumRoverEntity.this.m_21573_().m_26571_()) {
               double dx = this.f_24975_ - TitaniumRoverEntity.this.m_20185_();
               double dy = this.f_24976_ - TitaniumRoverEntity.this.m_20186_();
               double dz = this.f_24977_ - TitaniumRoverEntity.this.m_20189_();
               float f = (float)(Mth.m_14136_(dz, dx) * (180D / Math.PI)) - 90.0F;
               float f1 = (float)(this.f_24978_ * TitaniumRoverEntity.this.m_21051_(Attributes.f_22279_).m_22135_());
               TitaniumRoverEntity.this.m_146922_(this.m_24991_(TitaniumRoverEntity.this.m_146908_(), f, 10.0F));
               TitaniumRoverEntity.this.f_20883_ = TitaniumRoverEntity.this.m_146908_();
               TitaniumRoverEntity.this.f_20885_ = TitaniumRoverEntity.this.m_146908_();
               if (TitaniumRoverEntity.this.m_20069_()) {
                  TitaniumRoverEntity.this.m_7910_((float)TitaniumRoverEntity.this.m_21051_(Attributes.f_22279_).m_22135_());
                  ...
                  TitaniumRoverEntity.this.m_146926_(this.m_24991_(TitaniumRoverEntity.this.m_146909_(), f2, 5.0F));
                  float f3 = Mth.m_14089_(TitaniumRoverEntity.this.m_146909_() * ((float)Math.PI / 180F));
                  TitaniumRoverEntity.this.m_21564_(f3 * f1);
                  TitaniumRoverEntity.this.m_21567_((float)((double)f1 * dy));
               } else {
                  TitaniumRoverEntity.this.m_7910_(f1 * 0.05F);
               }
            } else {
               TitaniumRoverEntity.this.m_7910_(0.0F);
               TitaniumRoverEntity.this.m_21567_(0.0F);
               TitaniumRoverEntity.this.m_21564_(0.0F);
            }
