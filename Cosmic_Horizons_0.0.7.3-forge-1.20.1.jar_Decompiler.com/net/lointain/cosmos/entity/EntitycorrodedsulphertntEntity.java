...
import net.lointain.cosmos.procedures.CheckunderTNT1Procedure;
import net.lointain.cosmos.procedures.EntitycorrodedsulphertntOnInitialEntitySpawnProcedure;
...
public class EntitycorrodedsulphertntEntity extends Monster {
   public EntitycorrodedsulphertntEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)CosmosModEntities.ENTITYCORRODEDSULPHERTNT.get(), world);
   }

   public EntitycorrodedsulphertntEntity(EntityType<EntitycorrodedsulphertntEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      EntitycorrodedsulphertntOnInitialEntitySpawnProcedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      return retval;
   }

   public void m_6075_() {
      super.m_6075_();
      CheckunderTNT1Procedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
