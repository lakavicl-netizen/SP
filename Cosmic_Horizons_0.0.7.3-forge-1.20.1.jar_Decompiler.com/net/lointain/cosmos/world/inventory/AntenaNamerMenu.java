...
public class AntenaNamerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public AntenaNamerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)CosmosModMenus.ANTENA_NAMER.get(), id);
