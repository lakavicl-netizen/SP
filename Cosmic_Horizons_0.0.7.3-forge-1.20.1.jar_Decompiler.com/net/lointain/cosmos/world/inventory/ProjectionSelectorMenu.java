...
public class ProjectionSelectorMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public ProjectionSelectorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)CosmosModMenus.PROJECTION_SELECTOR.get(), id);
