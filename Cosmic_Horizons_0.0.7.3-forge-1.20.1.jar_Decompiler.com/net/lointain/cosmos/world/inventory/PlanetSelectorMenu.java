...
public class PlanetSelectorMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public PlanetSelectorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)CosmosModMenus.PLANET_SELECTOR.get(), id);
